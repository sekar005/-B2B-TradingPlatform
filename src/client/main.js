...
import EditCompanyComponent from './components/CompanyProfile/EditCompanyProfile/EditCompanyComponent';
...
render((
    <Router history={hashHistory}>
        ...
        <Route path="/template" component={TemplateComponent}>
            ...
            <Route path="/editCompany" component={EditCompanyComponent} />
